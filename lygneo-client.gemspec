...
Gem::Specification.new do |s|
  s.name = %q{lygneo-client}
  s.version = "0.1.3.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Lygneo, Inc."]
  s.date = %q{2011-06-09}
  s.description = %q{a gem to help with authentication and communicating with a Lygneo server}
  s.email = %q{maxwell@joinlygneo.com}
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  s.files = [
    ...
    "Rakefile",
    "VERSION",
    "lib/lygneo-client.rb",
  ]
  s.homepage = %q{http://github.com/lygneo/lygneo-client}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.1}
  s.summary = %q{A client for connecting to Lygneo pods using OAuth2}
